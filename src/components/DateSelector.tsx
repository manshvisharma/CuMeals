  ...
  return (
    <div className="mb-4">
      <div className="flex items-center gap-2">
        ...
        <div className="flex-1 flex items-center justify-between gap-1.5 bg-[#131722] p-1.5 rounded-[26px] border border-slate-800/80 shadow-sm overflow-x-auto no-scrollbar">
          {surroundingDates.map((dateStr) => {
            ...
            return (
              ...
              >
                ...
                <span className={`text-sm font-extrabold leading-tight ${isSelected ? 'text-white' : 'text-slate-100'}`}>
                  {dayNum}
                </span>
        ...
        <button
          ...
          className="p-3.5 rounded-[22px] bg-[#131722] border border-slate-800/80 text-slate-200 hover:bg-slate-800/80 hover:text-white transition-all shadow-sm active:scale-95 shrink-0 flex items-center justify-center"
          title="Open Calendar"
